...
const Notification = () => {
  ...
  const checkStockStatus = (productId, requestQuantity) => {
    ...
    if (product.quantity > 0 && product.quantity < requestQuantity)
      return 'insufficient' // ไม่เพียงพอ
    return 'insufficient' // สินค้าหมด
  }

  // ฟังก์ชันสำหรับดึงข้อมูลสต็อกปัจจุบันของสินค้า
  const currentStock = (productId) => {
    const product = products.find((p) => p.id === productId) // หา product จาก productData
    return product ? product.quantity : 0 // ถ้าหาเจอ ให้คืนค่าปริมาณในสต็อก ถ้าไม่เจอ คืนค่า 0
  }
              ...
              >
                <Card.Body>
                  ...
                  <div className='small mb-2'>
                    ...
                    <p className='mb-1'>
                      <strong>สต๊อกสินค้าปัจจุบัน:</strong>{' '}
                      {currentStock(request.productId)}
                    </p>
                    <p className='mb-1'>
